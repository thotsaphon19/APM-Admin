...
export const NOTI_CONFIG = {
  ...
  mailbox_fill:{ emoji:'🔑', color:'#059669', bg:'#f0fdf4', border:'#bbf7d0', label:'ได้รับเมลงาน' },
  duty:       { emoji:'🌙', color:'#4338ca', bg:'#eef2ff', border:'#c7d2fe', label:'จัดเวร' },
  duty_week:  { emoji:'📅', color:'#0f766e', bg:'#f0fdfa', border:'#99f6e4', label:'เวรสัปดาห์' },
  parcel_overdue:{ emoji:'⚠️', color:'#be123c', bg:'#fff1f2', border:'#fecdd3', label:'พัสดุค้าง' },
  new_employee:{ emoji:'🎉', color:'#7c3aed', bg:'#f5f3ff', border:'#ddd6fe', label:'เพิ่มพนักงาน' },

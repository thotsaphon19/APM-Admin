    ...
    <div className="app-shell">
      ...
      <nav className={sidebarClass}>
        ...
        <div className="sidebar-nav">
          {loading || !profile ? (
            <div style={{ padding:'20px 16px', color:'rgba(255,255,255,.5)', fontSize:13, textAlign:'center' }}>
              ⏳ กำลังโหลดเมนู...
            </div>
          ) : !profile.role || !Object.keys(ROLE_STYLE).includes(profile.role) ? (
            <div style={{ padding:'16px', color:'rgba(255,200,100,.8)', fontSize:12, textAlign:'center', lineHeight:1.6 }}>

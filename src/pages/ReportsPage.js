            ...
            {chartData.length > 0 ? (
              <ResponsiveContainer width="100%" height={250}>
                <ChartComponent data={chartData}>
                  ...
                  <XAxis dataKey="date" tick={{ fill: '#9096b8', fontSize: 11 }} axisLine={false} tickLine={false} />
                  <YAxis tick={{ fill: '#9096b8', fontSize: 11 }} axisLine={false} tickLine={false} />
                  <Tooltip contentStyle={{ background: '#1a1b2e', border: '1px solid rgba(255,255,255,0.1)', borderRadius: 8 }} />
                  <Legend />
                  {chartType === 'bar' ? (
                    <>
              ...
              {byPageData.length > 0 ? (
                <ResponsiveContainer width="100%" height={220}>
                  <BarChart data={byPageData} layout="vertical" barSize={12}>
                    ...
                    <XAxis type="number" tick={{ fill: '#9096b8', fontSize: 10 }} axisLine={false} tickLine={false} />
                    <YAxis dataKey="name" type="category" tick={{ fill: '#9096b8', fontSize: 10 }} axisLine={false} tickLine={false} width={80} />
                    <Tooltip contentStyle={{ background: '#1a1b2e', border: '1px solid rgba(255,255,255,0.1)', borderRadius: 8 }} />
              ...
              {byUserData.length > 0 ? (
                <ResponsiveContainer width="100%" height={220}>
                  <BarChart data={byUserData} barSize={14}>
                    <CartesianGrid strokeDasharray="3 3" stroke="rgba(255,255,255,0.05)" />
                    <XAxis dataKey="name" tick={{ fill: '#9096b8', fontSize: 10 }} axisLine={false} tickLine={false} />
                    <YAxis tick={{ fill: '#9096b8', fontSize: 10 }} axisLine={false} tickLine={false} />
                    <Tooltip contentStyle={{ background: '#1a1b2e', border: '1px solid rgba(255,255,255,0.1)', borderRadius: 8 }} />
                    <Legend />

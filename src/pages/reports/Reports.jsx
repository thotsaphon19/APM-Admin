        ...
        <div className="space-y-5">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
            <div className="card border-brand-500/30 bg-brand-500/5 text-center">
              ...
              <div className="text-xs text-gray-500 mt-1">{monthComms.length} รายการ</div>
            </div>
            <div className="card border-purple-500/30 bg-purple-500/5 text-center">
              ...
              <div className="text-xs text-gray-500 mt-1">{grand.manualOrders.toLocaleString()} บ้าน</div>
            </div>
            <div className="card border-emerald-500/30 bg-emerald-500/5 text-center">
              ...
              <div className="text-xs text-gray-500 mt-1">{grand.aiOrders.toLocaleString()} บ้าน</div>
            </div>
            <div className="card border-red-500/30 bg-red-500/5 text-center">
              ...
              <div className="text-xs text-gray-500 mt-1">{grand.cancelOrders} ยกเลิก / {grand.unclearOrders} ไม่ชัด</div>
            </div>
          </div>
                ...
                {adminSummary.filter(a=>a.total>0).slice(0,3).map((a,i)=>(
                  <div key={a.id} className={`rounded-xl p-4 border text-center ${
                    ...
                    <div className={`text-xl font-black mt-1 ${
                      i===0?'text-amber-400':i===1?'text-gray-500':'text-orange-600'}`}>
                    ...
                    <tbody>
                      {dailyData.map(d=>(
                        <tr key={d.date}>
                          ...
                          <td className="text-right text-gray-500">{d.orders}</td>
                          <td className="text-right font-black text-brand-400">฿{d.รวม.toLocaleString()}</td>
                        </tr>
                      ))}
                      <tr className="bg-indigo-50">
                        <td className="font-bold text-xs text-gray-500">รวมเดือน</td>
            ...
            <div className="table-wrap">
              <table>
                ...
                <tbody>
                  ...
                  <tr className="bg-indigo-50">
                    <td className="font-bold text-xs text-gray-500">รวมทั้งปี</td>
          ...
          {adminSummary.length===0
            ...
            : adminSummary.map((a,idx)=>(
              <div key={a.id} className="card p-0 overflow-hidden">
                {/* Summary row */}
                <div className="flex flex-wrap items-center gap-4 p-4 cursor-pointer hover:bg-indigo-50/50 transition-colors"
                  onClick={()=>setExpandAdmin(expandAdmin===a.id?null:a.id)}>
                  <div className="flex items-center gap-3 flex-1 min-w-0">
                    <span className="text-lg font-black text-gray-600 w-6 flex-shrink-0 text-center">
                      {idx<3?['🥇','🥈','🥉'][idx]:`#${idx+1}`}
                    </span>
                  ...
                  <div className="flex flex-wrap gap-6 items-center justify-end flex-1">
                    ...
                    <div className="text-right">
                      ...
                      <div className={`text-xl font-black ${a.total>0?'text-brand-400':'text-gray-500'}`}>
                        ฿{a.total.toLocaleString()}
                      </div>
                      {/* dominant badge */}
                ...
                {expandAdmin===a.id && (
                  <div className="border-t border-indigo-100 bg-white">
                    ...
                    <div className="px-5 py-3 border-b border-indigo-100">
                      ...
                      <div className="h-2.5 bg-indigo-50 rounded-full overflow-hidden flex">
                    ...
                    <div className="table-wrap px-2 pb-3">
                      <table>
                        ...
                        <tbody>
                          ...
                          <tr className="bg-indigo-50">
                            <td colSpan={2} className="font-bold text-xs text-gray-500">รวม</td>
            ...
            : <div className="table-wrap">
                <table>
                  ...
                  <tbody>
                    ...
                    <tr className="bg-indigo-50">
                      <td colSpan={3} className="font-bold text-xs text-gray-500">รวมทุกเพจ</td>
              ...
              {adminSummary.filter(a=>a.entries>0).map(a=>(
                <div key={a.id} className={`flex items-center gap-3 p-3 rounded-xl border ${
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="h-1.5 bg-indigo-50 rounded-full overflow-hidden flex mt-1.5">

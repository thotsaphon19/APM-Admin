  ...
  return (
    <div ref={ref} style={{ position: 'relative' }}>
      ...
      <button onClick={() => setOpen(o => !o)} style={{
        ...
        transition: 'all .2s', color: open ? 'var(--accent-gold)' : 'var(--text-secondary)',
      }}>
        🔔
        {unread > 0 && (
          <span style={{
          ...
          <div style={{
            ...
            {unread > 0 && (
              <button onClick={markAllRead} style={{
                ...
                fontSize: 11, color: 'var(--accent-blue)', fontFamily: 'inherit',
              }}>อ่านทั้งหมด</button>
            )}
          </div>
            ...
            {notifs.map(n => {
              ...
              return (
                <div key={n.id} onClick={() => { if (!isRead) markRead(n.id); }} style={{
                  ...
                  background: isRead ? 'transparent' : 'rgba(79,142,247,0.06)',
                  ...
                  <div style={{
                    ...
                    background: isRead ? 'var(--bg-surface)' : 'rgba(79,142,247,0.12)',
